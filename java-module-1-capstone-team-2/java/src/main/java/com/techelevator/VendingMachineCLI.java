...
public class VendingMachineCLI {
	...
	public VendingMachineCLI(Menu menu) throws FileNotFoundException {
		// Constructor - user will pass a menu for this class to use
	...
	public void endMethodProcessing() throws IOException {
		ourVendingMachine.writeTransactionReport();
		// actually calls this method and executes it
	}
}
